...
const S = {
  ...
  sendBtn: (disabled) => ({ background: disabled ? '#1a2535' : '#6d28d9', border:'none', borderRadius:'8px', padding:'8px 16px', color: disabled ? '#2e4060' : 'white', cursor: disabled ? 'not-allowed' : 'pointer', fontSize:'13px', fontWeight:'600', transition:'background 0.15s', whiteSpace:'nowrap' }),
  ...
  bigSendBtn: (disabled) => ({ width:'100%', background: disabled ? '#1a2535' : '#6d28d9', border:'none', borderRadius:'8px', padding:'11px', color: disabled ? '#2e4060' : 'white', cursor: disabled ? 'not-allowed' : 'pointer', fontSize:'14px', fontWeight:'600', transition:'background 0.15s' }),
};
