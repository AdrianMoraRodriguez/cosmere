        ...
        <div className="p-6">
          {messages.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-white text-lg font-semibold">No tienes mensajes</p>
              <p className="text-blue-300 text-sm mt-2">El DM te enviará mensajes secretos aquí</p>
            </div>
          ) : (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-white font-bold">Dungeon Master</span>
                    </div>
